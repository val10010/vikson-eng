        ...
        <section className={style.container}>
            ...
            <div className={style.content}>
                ...
                <ul className={style.benefits}>
                    <li className={style.benefit}>Аналіз твого рівня англіскої експертом</li>
                    <li className={style.benefit}>Демонстрація процессу навчання (виконаємо 2 круті вправи)</li>
                    <li className={style.benefit}>Розповідь про авторську систему навчання в <span className={style.highlightedText}>Miro</span></li>
                    <li className={style.benefit}>Відповіді на усі твої запитання</li>
                </ul>
                <Toggle>
